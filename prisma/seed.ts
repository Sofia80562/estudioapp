...
const PERMISSIONS = [
	...
	{ module: 'tasks', action: 'create', description: 'Crear tareas de estudio' },
	{ module: 'tasks', action: 'read', description: 'Consultar tareas de estudio' },
	{ module: 'tasks', action: 'update', description: 'Actualizar tareas de estudio' },
	{ module: 'tasks', action: 'delete', description: 'Eliminar tareas de estudio' },
	{ module: 'tasks', action: 'manage', description: 'Administrar todas las tareas' },
];

/**
 * Catálogo de menús adaptado a EstudioApp.
 */
const MENU_GROUPS = [
...
const MENU_ITEMS: MenuItemSeed[] = [
	...
	},
	{
		...
		route: '/app/tasks',
		parentCode: 'productivity',
		permissionCodes: ['tasks.read'],
	},
];
 ...
 * borrar nunca) los códigos sembrados que ningún `access(...)` exige hoy.
 */
