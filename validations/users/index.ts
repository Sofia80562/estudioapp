...
// Mensajes de validación estándar reutilizables
const VALIDATION_MESSAGES = {
	REQUIRED: 'Este campo es obligatorio.',
	EMAIL: 'Ingresa un correo electrónico válido.',
	UUID: 'El identificador debe ser un UUID válido.',
	MIN_VALUE: (min: number) => `El valor mínimo permitido es ${min}.`,
	MAX_VALUE: (max: number) => `El valor máximo permitido es ${max}.`,
	MAX_LENGTH: (max: number) => `No puede superar los ${max} caracteres.`,
};
