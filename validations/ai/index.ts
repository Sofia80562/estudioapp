...
export const studySlotRecommendationsSchema = z
	.object({
		from: instant,
		to: instant,
...
export const upcomingStudySessionsSummarySchema = z
...
export type StudySlotRecommendationsBody = z.infer<typeof studySlotRecommendationsSchema>;
export type UpcomingStudySessionsSummaryBody = z.infer<typeof upcomingStudySessionsSummarySchema>;