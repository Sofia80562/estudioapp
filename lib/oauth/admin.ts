...
// API de administración de Keycloak — usada para crear la identidad real de un usuario en el registro.
// Usa el cliente de servicio (client_credentials, rol de cliente `manage-users`).
...
/** Compensación: si el paso posterior en EstudioApp falla, se revierte la creación en Keycloak. */
