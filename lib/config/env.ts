...
const envSchema = z.object({
	...
	// Cliente público para la app móvil (EstudioApp Mobile, Capacitor)
	OAUTH_MOBILE_CLIENT_ID: z.string().min(1).default('estudioapp-mobile'),
	// Cliente de servicio para el registro público
	...
	SESSION_COOKIE_NAME: z.string().min(1).default('estudioapp_session'),
	SESSION_TEMP_COOKIE_NAME: z.string().min(1).default('estudioapp_oauth_state'),
